  ...
  return (
    <form action={formAction} className="max-w-lg space-y-3 rounded-lg border border-[var(--border)] bg-white p-5 shadow-xs">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <input name="discountValue" type="number" step="0.01" placeholder="Value" required className="rounded-lg border border-[var(--border)] px-3.5 py-2.5 outline-none transition-colors focus:border-brand-teal focus:ring-2 focus:ring-brand-teal/15 text-sm" />
      </div>
      <div className="grid grid-cols-2 gap-3">
